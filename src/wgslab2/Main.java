...
//		Country = Tool.changeCode(Country);
		Statement stmt = Tool.initSQL("library", "root","wgs0520");
...
//		Price = Tool.changeCode(Price);
		Statement stmt = Tool.initSQL("library", "root","wgs0520");
		stmt.executeUpdate("insert into book values (\""+ISBN+"\",\""+Title+"\",\""+AuthorId+"\",\""+Publisher+"\",\""+PublishDate+"\",\""+Price+"\")"); 
